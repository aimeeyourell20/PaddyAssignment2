...
public class Registration_Admin extends AppCompatActivity {
    ...
    private Button mAdminSignUpButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdminSignUpButton = findViewById(R.id.adminSignUpButton);

        firebaseAuth = FirebaseAuth.getInstance();

        mAdminSignUpButton.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void signupUser() {
        ...
        firebaseAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (!task.isSuccessful()) {
                    Toast.makeText(Registration_Admin.this, "Registration unsuccessful", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    RootRef.updateChildren(mentee).addOnCompleteListener(new OnCompleteListener() {
                        ...
                        public void onComplete(@NonNull Task task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(Registration_Admin.this, "User info successfully added", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(Registration_Admin.this, "Error", Toast.LENGTH_SHORT).show();
                            }
                            finish();
                        }
                    });
        ...
        Intent i = new Intent(Registration_Admin.this, Login.class);
        startActivity(i);
        finish();;
    }
}